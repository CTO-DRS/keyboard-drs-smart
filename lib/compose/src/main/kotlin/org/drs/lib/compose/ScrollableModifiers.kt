...
fun Modifier.drsVerticalScroll(
    ...
    if (showScrollbar) {
        verticalScroll(scrollState).drsScrollbar(scrollState, scrollbarWidth, isVertical = true)
    } else {
        verticalScroll(scrollState)
    }
}

fun Modifier.drsHorizontalScroll(
    state: ScrollState? = null,
    showScrollbar: Boolean = true,
    ...
    val scrollState = state ?: rememberScrollState()
    if (showScrollbar) {
        horizontalScroll(scrollState).drsScrollbar(scrollState, scrollbarHeight, isVertical = false)
    } else {
        horizontalScroll(scrollState)
    }
}

fun Modifier.drsScrollbar(
    state: ScrollState,
