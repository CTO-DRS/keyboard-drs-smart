...
data class SnyggStylesheet internal constructor(
    ...
    companion object {
        const val SCHEMA_V2 = "https://schemas.drs-keyboard.org/snygg/v2/stylesheet"

        /**
         * Accepts only the current DRS schema host. Stylesheets carrying any
         * other schema host are rejected during import validation; built-in
         * packages always ship the current host and imported legacy files are
         * silently rewritten to it on first load.
         */
        private val SCHEMA_PATTERN = """^https://schemas\.drs-keyboard\.org/snygg/v[0-9]+/stylesheet$""".toRegex()
