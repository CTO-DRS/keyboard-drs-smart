...
class ModelProcessor(private val env: SymbolProcessorEnvironment) : SymbolProcessor {
    companion object {
        const val PREFERENCE_DATA_QUALIFIED_NAME = "org.drs.jetpref.datastore.model.PreferenceData"
        const val PREFERENCES_QUALIFIED_NAME = "org.drs.jetpref.datastore.annotations.Preferences"
        const val PREFERNCE_MODEL_DUPLICATE_KEY_EXCEPTION_QUALIFIED_NAME =
            "org.drs.jetpref.datastore.runtime.PreferenceModelDuplicateKeyException"
        const val TYPED_KEY_QUALIFIED_NAME = "org.drs.jetpref.datastore.model.PreferenceModel.TypedKey"
    }
