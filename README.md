...
| 🩺 **تشخيص ذاتي** | فحوصات حية لكل مكوّن مع حلول مقترحة مفهومة |
...
| ⚡ **التقني** | عاشق التحكم | أدوات، اختصارات، إعدادات متقدمة لكل سلوك |
...
فحص أحدث إصدار عبر واجهة GitHub الرسمية، عرض رقم الإصدار والحجم والتاريخ والوصف، تنزيل بشريط تقدم حقيقي مع إيقاف/استئناف، تحقق SHA-256 إلزامي مقابل `SHA256SUMS.txt`، ثم تثبيت بالمسار الرسمي لأندرويد. الفحص التلقائي اختياري (يومي/أسبوعي/يدوي) مع إشعار عند توفر إصدار.
...
| 📱 APK الحالي | `DRS-Smart-Keyboard-v1.0.0.apk` من صفحة الإصدار |
...
> للتحقق من سلامة التنزيل: حجم APK الصحيح 29,831,969 بايت وبصمته موثقة في `SHA256SUMS.txt`.
