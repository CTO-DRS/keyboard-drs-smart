...
| 📱 APK الحالي | `DRS-Smart-Keyboard-v1.0.4.apk` من صفحة الإصدار |
...
> للتحقق من سلامة التنزيل: قارن حجم الملف وبصمته مع القيم المدونة في ملف `SHA256SUMS.txt` المرفق بالإصدار — إن اختلف أي منهما فالتنزيل غير مكتمل؛ أعِد تنزيل الملف من جديد.
