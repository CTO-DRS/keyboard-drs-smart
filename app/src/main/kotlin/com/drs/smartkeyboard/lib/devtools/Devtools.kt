...
package com.drs.smartkeyboard.lib.devtools
...
import com.drs.smartkeyboard.lib.util.TimeUtils
import com.drs.smartkeyboard.lib.util.UnitUtils
...
object Devtools {
    fun generateDebugLog(context: Context, prefs: DrsPreferenceModel? = null, includeLogcat: Boolean = false): String {
        return buildString {
    ...
    fun generateDebugLogHeader(context: Context, prefs: DrsPreferenceModel? = null): String {
        return buildString {
    ...
    fun generateDebugLogForGithub(context: Context, prefs: DrsPreferenceModel? = null, includeLogcat: Boolean = false): String {
        return buildString {
            appendLine("<details>")
    ...
    fun generateAppInfoLog(context: Context, withTitle: Boolean = true): String {
        return buildString {
            ...
            append("Name                : ").appendLine(context.resources.getString(R.string.drs_app_name))
    ...
    fun generateFeatureConfigLog(prefs: DrsPreferenceModel, withTitle: Boolean = true): String {
        return buildString {
