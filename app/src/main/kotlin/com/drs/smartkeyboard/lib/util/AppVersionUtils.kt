...
object AppVersionUtils {
    ...
    fun shouldShowChangelog(context: Context, prefs: DrsPreferenceModel): Boolean {
        val installVersion =
    ...
    suspend fun updateVersionOnInstallAndLastUse(context: Context, prefs: DrsPreferenceModel) {
    ...
    suspend fun updateVersionLastChangelog(context: Context, prefs: DrsPreferenceModel) {
