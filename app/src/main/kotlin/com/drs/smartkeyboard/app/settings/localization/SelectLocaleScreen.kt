...
@Composable
fun SelectLocaleScreen() = DrsScreen {
    ...
    val systemLocales =
        DrsLocale.extendedAvailableLocales(context).sortedBy { locale ->
        ...
        if (searchTermValue.text.isBlank()) {
            ...
            systemLocales.filter { locale ->
                locale.displayName().lowercase().contains(term) ||
                    ...
                    locale.displayName(DrsLocale.ENGLISH).lowercase().contains(term) ||
    ...
    content {
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            ...
            LazyColumn(
                modifier = Modifier
                    .weight(1f)
                    .drsScrollbar(state, isVertical = true),
                state = state,
            ) {
