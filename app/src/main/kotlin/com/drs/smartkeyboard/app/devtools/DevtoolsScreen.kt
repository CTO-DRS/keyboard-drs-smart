...
import com.drs.smartkeyboard.ime.dictionary.DrsUserDictionaryDatabase
            ...
            DrsConfirmDeleteDialog(
                onConfirm = {
                    DictionaryManager.default().let {
                        ...
                        it.drsUserDictionaryDao()?.deleteAll()
                    }
                    setShowDialog(false)
                },
                onDismiss = { setShowDialog(false) },
                what = DrsUserDictionaryDatabase.DB_FILE_NAME,
            )
        }
    }
}
