    ...
    content {
        ...
        CompositionLocalProvider(LocalLayoutDirection provides LayoutDirection.Ltr) {
            SelectionContainer(
                ...
                val licenseText = DrsRef.assets("license/project_license.txt").loadTextAsset(
                    context
                ).getOrElse {
