...
import com.drs.smartkeyboard.lib.UnicodeCtrlChar
import org.drs.jetpref.material.ui.ColorRepresentation
import org.drs.lib.kotlin.simpleNameOrEnclosing
import org.drs.lib.snygg.Snygg
import org.drs.lib.snygg.SnyggElementRule
import org.drs.lib.snygg.value.SnyggCircleShapeValue
...
import org.drs.lib.snygg.value.SnyggInheritValue
import org.drs.lib.snygg.value.SnyggNoValue
...
import org.drs.lib.snygg.value.SnyggRectangleShapeValue
...
import org.drs.lib.snygg.value.SnyggYesValue
...
internal fun Context.translateElementName(element: String, level: SnyggLevel): String? {
    return when (level) {
        ...
        else -> DrsImeUi.elementNamesToTranslation[element]?.let { getString(it) }
    }
}
