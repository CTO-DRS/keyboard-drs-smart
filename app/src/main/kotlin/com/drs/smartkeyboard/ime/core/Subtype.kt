...
import com.drs.smartkeyboard.ime.keyboard.LayoutTypeId
...
import com.drs.smartkeyboard.ime.keyboard.extCorePunctuationRule
...
data class Subtype(
    val id: Long,
    val primaryLocale: DrsLocale,
    val secondaryLocales: List<DrsLocale>,
    ...
    companion object {
         ...
         *
         * DRS: Arabic is the native language of the app, so the fallback subtype
         * (used on first run before the user configures any subtype) is Arabic,
         * mirroring the official "ar" subtype preset of org.drs.localization.
         */
        val DEFAULT = Subtype(
            id = -1,
            primaryLocale = DrsLocale.from("ar"),
            ...
            layoutMap = SubtypeLayoutMap(
                characters = extCoreLayout("arabic"),
                symbols = extCoreLayout("eastern"),
                symbols2 = extCoreLayout("eastern"),
                numericRow = extCoreLayout("eastern_arabic"),
            ),
        )
    }
