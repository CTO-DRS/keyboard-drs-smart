...
class DrsEditorInfo private constructor(val base: EditorInfo) {
    ...
    companion object {
        val Unspecified = DrsEditorInfo(EditorInfo())

        fun wrap(editorInfo: EditorInfo) = DrsEditorInfo(editorInfo)
    }
}
