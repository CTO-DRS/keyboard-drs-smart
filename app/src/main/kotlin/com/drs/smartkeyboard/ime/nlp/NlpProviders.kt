...
interface SuggestionProvider : NlpProvider {
    ...
    /**
     * DRS: learn an externally committed word, i.e. a word typed by the user and committed
     * with space/punctuation instead of being picked from the suggestion row. Implementations
     * may store it in the personal user dictionary to improve future suggestions. Default
     * implementation is a no-op.
     *
     * @param subtype Information about the current subtype, primarily used for the language
     *  the word should be learned for.
     * @param word The committed word.
     * @param isPrivateSession Flag indicating if the word was committed within a private
     *  session. If true, implementations MUST NOT learn the word.
     */
    suspend fun learnExternalWord(subtype: Subtype, word: String, isPrivateSession: Boolean) {
        // Default: do nothing
    }
...
object FallbackNlpProvider : SpellingProvider, SuggestionProvider {
    override val providerId = "org.drs.nlp.providers.fallback"
