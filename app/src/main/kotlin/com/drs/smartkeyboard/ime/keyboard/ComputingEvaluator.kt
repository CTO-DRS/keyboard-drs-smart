...
import com.drs.smartkeyboard.lib.compose.vectorResource
import org.drs.lib.compose.icons.ForwardDelete
...
object DefaultComputingEvaluator : ComputingEvaluator {
    ...
    override val editorInfo = DrsEditorInfo.Unspecified
...
private var cachedDisplayNameState = Triple(DrsLocale.ROOT, DisplayLanguageNamesIn.SYSTEM_LOCALE, "")
 ...
 */
private fun computeLanguageDisplayName(locale: DrsLocale, displayLanguageNamesIn: DisplayLanguageNamesIn): String {
...
fun ComputingEvaluator.computeImageVector(data: KeyData): ImageVector? {
    ...
    return when (data.code) {
        ...
        KeyCode.TOGGLE_FLOATING_WINDOW -> {
            ...
            val windowController = DrsImeService.windowControllerOrNull() ?: return enabledIcon
