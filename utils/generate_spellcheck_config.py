...
"""generate_spellcheck_config.py: Simple helper script for auto generating the spell check config
   ...
   keyboard subtype, and Android ignores the DRS Smart Keyboard spell checker unless it declares the currently active system
   ...
   Before running this script, make sure that exactly one device is connected and that DRS Keyboard Debug
...
PULL_CMD_INPUT = """run-as com.drs.smartkeyboard.debug
...
<spell-checker xmlns:android="http://schemas.android.com/apk/res/android"
    android:label="@string/drs_app_name"
    android:settingsActivity="com.drs.smartkeyboard.SettingsLauncherAlias">
"""
